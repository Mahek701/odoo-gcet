...
function handleTabSwitch(tabName) {
    ...
    if (tabName === 'attendance') {
        // Redirect to attendance page based on user role
        // TODO: Replace 'admin' with actual user role from authentication system
        const userRole = 'admin'; // This should come from your authentication system
        if (userRole === 'admin' || userRole === 'hr') {
            window.location.href = '../attendence/attedence_admin.html';
        } else {
            window.location.href = '../attendence/attendence_employee.html';
        }
    } else if (tabName === 'timeoff') {
        // Redirect to time off page based on user role
        // TODO: Replace 'admin' with actual user role from authentication system
        const userRole = 'admin'; // This should come from your authentication system
        if (userRole === 'admin' || userRole === 'hr') {
            window.location.href = '../timeoff/timeoff_admin.html';
        } else {
            window.location.href = '../timeoff/timeoff_employee.html';
        }
    }
